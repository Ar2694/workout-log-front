...
import styles from "./MobileDay.module.css";
...
export default function MobileDay(props: CustomDayProps) {
  ...
  const dayItems = chipItem.length > 0 ? chipItem : <Typography component="span" fontSize={14}>No Events</Typography>;
      ...
      <Stack direction="column" alignItems="flex-start" width="100%">
        <Stack className="date-container" direction="row" width="100%" alignItems="center" justifyItems="flex-start">
          <Box flexGrow={1} textAlign="left">
            <Typography component="span" fontWeight={600} fontSize={18}>{day.format("ddd, MMM DD")}</Typography>
          </Box>
        </Stack>
        <Box component={Stack} className="chip-container" width="inherit" spacing={3}>
          {dayItems}
        </Box>
      </Stack>
    </PickersDay>
